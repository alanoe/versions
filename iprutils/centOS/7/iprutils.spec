...
%changelog
* Thu Nov 3 2016 Mauro S. M. Rodrigues <maurosr@linux.vnet.ibm.com> - 2.4.13-2
- Spec cleanup: Remove indirections in Release tag.

* Thu Oct 06 2016 Lucas Tadeu Teixeira <ltadeu@br.ibm.com>
- Run bootstrap.sh in the spec file build step
