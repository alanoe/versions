...
### Sources
# original from: ftp://ftp.kernel.org/pub/linux/utils/util-linux/v2.23/util-linux-2.23.tar.xz

Source0: util-linux.tar.gz
...
Patch54: 2.26-nsenter-selinux.patch
...
Patch139790: ibmbug139790-upstream.fix.for.lscpu.model.and.model.name.on.power.patch
...
# build nologin
%{__cc} $CFLAGS -o nologin nologin.c

pushd libuuid
ln -s src/uuid.h uuid.h
popd
